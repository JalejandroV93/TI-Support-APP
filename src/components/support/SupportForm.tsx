...
interface SupportFormProps {
  ...
  handleSelectChange: (name: keyof SupportReportFormState, value: string | number) => void; // Type correctly
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div>
                ...
                <Select
                    onValueChange={(value) => handleSelectChange("categoriaId", parseInt(value, 10))}
